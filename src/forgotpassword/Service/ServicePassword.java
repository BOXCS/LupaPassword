package forgotpassword.Service;

import forgotpassword.connection.DatabaseConnection;
...
public class ServicePassword {
    ...
    public void sendPassword(String recipientEmail, String password) {
        final String senderEmail = "alamat email untuk mengirim email"; // Ganti dengan alamat email 
        final String senderPassword = "token akun bukan sandi"; // Ganti dengan token email
